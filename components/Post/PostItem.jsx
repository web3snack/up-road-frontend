...
const PostItem = ({ setLinkHandler, setDescriptionHandler, removeContent, content }) => {
  ...
  return (
    <div className='relative w-5/6 h-auto mx-auto my-8 flex items-center'>
      <SlideToggle>
        {({ toggle, setCollapsibleElement }) => (
          <div className="my-collapsible px-[10px] py-2 rounded-xl w-full border">
            <div className='flex items-center'>
              <div className='absolute top-0 transform transition-y-1/2 -left-12'>
            ...
            <div className="my-collapsible__content" ref={setCollapsibleElement}>
              <textarea name="description" rows="4" className='block w-full mt-2 pl-2 text-lg placeholder:text[#eee] outline-none resize-none' placeholder='Description' onChange={getInputDescription}/>
            </div>
          </div>
        )}
      </SlideToggle>
      <div className='absolute top-0 transform translate-y-1 -right-12'>
